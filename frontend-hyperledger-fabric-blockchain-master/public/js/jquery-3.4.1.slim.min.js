  ...
  var h = (function(n) {
    ...
    function ue() {
      ...
      return function e(t, n) {
        return (
          r.push(t + ' ') > x.cacheLength && delete e[r.shift()], (e[t + ' '] = n)
        );
      };
    }
    function le(e) {
    ...
    special: {
      ...
      click: {
        setup: function(e) {
          var t = this || e;
          return (
            fe.test(t.type) && t.click && S(t, 'input') && Se(t, 'click', Ee), !1
          );
        },
        trigger: function(e) {
          var t = this || e;
        ...
        ? ((i = x(n)),
          this.each(function(e) {
            ...
            1 === this.nodeType &&
              ...
              ((r =
                E.valHooks[this.type] || E.valHooks[this.nodeName.toLowerCase()]) &&
                'set' in r &&
